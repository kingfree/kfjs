...
if($_POST['lang_type']=='auto') {
	if($_FILES["file"]["type"]=="text/x-pascal")
		$Complie_CMD = Get_Complie_CMD($upload_file_name, $outputdir, 2);
	elseif($_FILES["file"]["type"]=="text/x-csrc")
		$Complie_CMD = Get_Complie_CMD($upload_file_name, $outputdir, 0);
	elseif($_FILES["file"]["type"]=="text/x-c++src")
		$Complie_CMD = Get_Complie_CMD($upload_file_name, $outputdir, 1);
	else {
